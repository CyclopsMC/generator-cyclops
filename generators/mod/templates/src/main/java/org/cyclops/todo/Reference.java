...
public class Reference {
    ...
    public static final String GA_TRACKING_ID = "<%= trackingid %>";
    public static final String VERSION_URL = "https://raw.githubusercontent.com/CyclopsMC/Versions/master/" + MinecraftHelpers.getMinecraftVersionMajorMinor() + "/<%= modname %>.txt";
