...
[![Build Status](https://github.com/CyclopsMC/<%= repo %>/workflows/CI/badge.svg)](https://github.com/CyclopsMC/<%= repo %>/actions?query=workflow%3ACI)
[![Download](https://img.shields.io/maven-metadata/v/https/oss.jfrog.org/artifactory/simple/libs-release/org/cyclops/<%= modid %>/<%= modname %>/maven-metadata.xml.svg) ](https://oss.jfrog.org/artifactory/simple/libs-release/org/cyclops/<%= modid %>/<%= modname %>/)
...
All stable releases (including deobfuscated builds) can be found on [CurseForge](http://minecraft.curseforge.com/projects/<%= cfid %>/files).
